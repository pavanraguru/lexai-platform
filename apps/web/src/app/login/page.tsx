...
// Flow: Supabase login → POST /v1/auth/token → store LexAI JWT
// ============================================================
...
export default function LoginPage() {
  ...
  const exchangeToken = async (supabaseToken: string) => {
    ...
    setUser({
      ...
      tenant_name: user.tenant_name || 'My Firm',
        ...
        <div>
          ...
          <div className="space-y-4">
            {[
              ...
              { icon: '📱', text: 'Client reminders via WhatsApp, 7 days before hearings' },
              { icon: '📄', text: 'Opening statements and bench Q&A in seconds' },
              { icon: '💰', text: 'Professional invoices with GST and UPI QR code' },
            ].map((item, i) => (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            ...
            <p className="text-gray-500 text-sm mb-8">
              {step === 'otp-verify' ? `We sent a code to +91${phone}` : 'Welcome back.'}
            </p>
              ...
              <div className="space-y-3">
                ...
                <button onClick={() => setStep('email')}
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Sign in with your email</p>
                  </div>
                  <ArrowRight size={16} className="ml-auto text-gray-400" />
                </button>
              </div>
              ...
              <form onSubmit={handleEmailLogin} className="space-y-4">
                <div>
                  ...
                  <input type="email" value={email}
                    ...
                    placeholder="advocate@firm.in" required autoComplete="email"
